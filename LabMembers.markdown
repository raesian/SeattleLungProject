...
<script>
    ...
    function openBioModal(card) {
        ...
        const modalHtml = `
            <div class="bio-modal-overlay active" onclick="closeBioModal(event)">
                <div class="bio-modal">
                    <button class="bio-modal-close" onclick="closeBioModal(event)">Ã—</button>
    ...
    function closeBioModal(event) {
        if (event) {
            ...
            if (event.target.classList.contains('bio-modal-overlay') || event.target.classList.contains('bio-modal-close') || event.target.innerText === 'Ã—') {
        ...
        i = `
            ...
            <div class = "card" onclick="openBioModal(this)" id = "i42">
                ...
                <div class = "content">
                    ...
                    <p>Ben is a junior at the University of Washington majoring in Biology: Physiology and joined the lab as an OR intern in September 2024. Outside of studying, working in the lab, or watching Instagram reels, he enjoys playing musical instruments and just about any sport with a ball and a netâ€”volleyball, spikeball, basketball, tennis, and soccer. He hopes to attend medical school after gaining more clinical experience as a nursing assistant, shadowing additional physicians, and building on his research experience.</p>
                </div>
            </div>
            ...
            <div class = "card" onclick="openBioModal(this)" id = "i38">
                ...
                <div class = "content">
                    ...
                    <p>Aditya is currently a sophomore at the University of Washington. He joined the lab as an OR intern in the spring of 2025. His hobbies revolve around the outdoorsâ€"he loves to swim, ski, and go on hikes. In his free time, he enjoys volunteering at his local farmers market.</p>
                </div>
            </div>
            ...
            <div class = "card" onclick="openBioModal(this)" id = "i49">
                ...
                <div class = "content">
                    ...
                    <h3>Sophomore</h3>
                    <h3>Public Health-Global Health</h3>
                    <p>I am currently a sophomore at the UW majoring in Public Health-Global Health. I joined as an OR intern in Autumn '25. My free time revolves mostly around musicâ€"I have been learning Indian classical vocal music since I was a toddler and I am a part of UW's South Asian a cappella team UW Awaaz!</p>
                </div>
            </div>
            ...
            <div class = "card" onclick="openBioModal(this)" id = "i50">
                ...
                <div class = "content">
                    <h2>Lena Czech</h2>
                    <h3>Undergraduate</h3>
                    <h3>Biochemistry and Public Healthâ€"Global Health</h3>
                    <p>Lena is an undergraduate student at the University of Washington, double majoring in Biochemistry and Public Healthâ€"Global Health. She joined the lab in October 2025. Lena enjoys the outdoors, reading, and traveling. She plans to pursue an MD after completing her undergraduate degree!</p>
                </div>
            </div>
            <!-- High School -->
    ...
    const memberData = {
        ...
        'i38': {
            ...
            bio: 'Aditya is currently a sophomore at the University of Washington. He joined the lab as an OR intern in the spring of 2025. His hobbies revolve around the outdoorsâ€”he loves to swim, ski, and go on hikes. In his free time, he enjoys volunteering at his local farmers market.'
        },
        'i39': {
        ...
        'i49': {
            name: 'Sruthi Alamuru',
            title: 'Sophomore - Public Health-Global Health',
            bio: 'I am currently a sophomore at the UW majoring in Public Health-Global Health. I joined as an OR intern in Autumn \'25. My free time revolves mostly around musicâ€“I have been learning Indian classical vocal music since I was a toddler and I am a part of UW\'s South Asian a cappella team UW Awaaz!'
        },
        'i50': {
            name: 'Lena Czech',
            title: 'Undergraduate - Biochemistry and Public Healthâ€“Global Health',
            bio: 'Lena is an undergraduate student at the University of Washington, double majoring in Biochemistry and Public Healthâ€“Global Health. She joined the lab in October 2025. Lena enjoys the outdoors, reading, and traveling. She plans to pursue an MD after completing her undergraduate degree!'
        }
    };
